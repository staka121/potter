...
func runBuild(args []string) error {
	...
	args = fs.Args()
	if len(args) == 0 {
		return fmt.Errorf("tsubo file path required. Usage: tsubo build <tsubo-file> [options]")
	}
...
func printBuildHeader() {
	...
	fmt.Printf("%sTsubo Build%s\n", colorBlue, colorReset)
	fmt.Printf("%s========================================%s\n", colorBlue, colorReset)
	fmt.Println()
}

func printBuildUsage() {
	fmt.Println("Usage: tsubo build <tsubo-file> [options]")
	fmt.Println()
	fmt.Println("Options:")
	...
	fmt.Println("  tsubo build app.tsubo.yaml")
	fmt.Println("  tsubo build app.tsubo.yaml --ai")
	fmt.Println("  tsubo build app.tsubo.yaml --ai --concurrency 4")
}
...
func printBuildSummary(plan *types.ImplementationPlan) {
	...
	fmt.Println("   tsubo build <tsubo-file> --ai")
	fmt.Println()
}
