...
func createServiceTemplate(serviceName string) error {
	...
	fmt.Printf("  3. Run: tsubo build <tsubo-file> --ai\n")
	fmt.Println()
...
func printNewUsage() {
	fmt.Println("Usage: tsubo new [service-name]")
	fmt.Println()
	...
	fmt.Println("  tsubo new              # Creates example.object.yaml")
	fmt.Println("  tsubo new user         # Creates user.object.yaml")
	fmt.Println("  tsubo new todo         # Creates todo.object.yaml")
}
