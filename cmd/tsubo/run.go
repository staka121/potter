...
func printRunUsage() {
	fmt.Println("Usage: tsubo run [options]")
	fmt.Println()
	...
	fmt.Println("  tsubo run                  # Start all services (foreground)")
	fmt.Println("  tsubo run -d               # Start all services (background)")
	fmt.Println("  tsubo run --service user   # Start user-service only")
}
